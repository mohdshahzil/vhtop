...
const Page: React.FC = () => {
  const hostelItems: HostelItems = {
    Electrical: ["Power Outage", "Faulty Wiring", "Socket Issue", "Others"],
    Plumbing: ["Leaking Pipes", "Clogged Drains", "No Water Supply", "Others"],
    Security: ["Broken Locks", "Unauthorized Entry", "Security Breach", "Others"],
    Maintenance: ["Appliance Repair", "Furniture Repair", "General Maintenance", "Others"],
    Others: ["Others"],
  };
